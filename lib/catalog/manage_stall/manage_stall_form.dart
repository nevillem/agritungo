...
TextEditingController stallNumber = TextEditingController();
GlobalKey<FormState> _addStall = GlobalKey<FormState>();

manageStallDialog(BuildContext context, String accessTokens, refreshTokens, sessionid) {
  return showDialog(
      context: context,
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      validator: (value) {
                        if (value!.isEmpty) {
                          return "Please Enter Stall No/Name";
                        } else
                          return null;
                      },
                      controller: stallNumber,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: FlatButton(
                          ...
                          onPressed: () {
                         if (_addStall.currentState!.validate()) {
                           _saveData(context, stallNumber.text, accessTokens, refreshTokens, sessionid);
    ...
    if (value) {
      ...
      Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (BuildContext context) => ManageStallMain()), (Route<dynamic> route) => false);
...
_saveData(context, stallName, String accessTokens, refreshTokens, sessionid) async {
  Map postdata = {
    "stallname": "$stallName"
  };
  var _json= utf8.encode(jsonEncode(postdata));
  String url = 'https://api.v1.agritungo.com/API/catalog/stall';
   ...
   if(response.statusCode==401){
     ...
     if (responseRefresh.statusCode == 200) {
       ...
       if(response2.statusCode==201){
         // await Navigator.popAndPushNamed(context, '/manage_stall_main');
